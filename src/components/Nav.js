      ...
      <header className="sticky top-0">
        ...
        <div className="flex justify-between items-center bg-black h-[4rem] w-[100%] p-[1rem] shadow-md z-[100]">
            <div className="flex gap-[1rem] text-[1.25rem]">
              ...
              <div className={`flex justify-center items-center w-[100vw] h-[15rem] absolute bg-white gap-[1rem] md:gap-[2rem] duration-500 shadow-2xl left-0 ${searchOpen? "top-0": "-top-[20rem]"}`}>
                <input type="text" placeholder="Search" className="flex bg-[#e3e3e3] w-[80vw] md:w-[40rem] h-[2.5rem] p-3 rounded-lg"/>
                <AiOutlineClose onClick={toggleSearch} className="cursor-pointer"/>
              </div>
            </div>
            <div className="flex h-[100%] items-center">
              <a href="wavesupps.com"><img src={logo} alt="Wave Logo" className="h-[3rem] allign"/></a>
            </div>
